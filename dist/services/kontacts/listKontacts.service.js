...
exports.listKontactsService = void 0;
...
const listKontactsService = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const kontacts = yield kontactsRepository.find({
        where: {
            user: user,
        },
    });
    return kontacts_schemas_1.kontactSchemaResponse.parse(kontacts);
});
exports.listKontactsService = listKontactsService;
